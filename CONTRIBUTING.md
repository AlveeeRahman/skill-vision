...
All 93 tests must pass on Python 3.9 through 3.13 (CI runs the full matrix on every
push and pull request).

## Two hard rules

1. **The repo must stay spec-conformant.** skill-pirate validates itself; this command
